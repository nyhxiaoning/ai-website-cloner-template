      ...
      <div className="relative mx-auto grid max-w-7xl items-stretch gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-12">
        ...
        <div>
          ...
          <p className="mt-3 text-[#6e665a]">
            Change clothes in photos with AI. Upload one photo, add up to 3 pieces
            — jacket, top, bag — and our AI outfit changer styles them into one
            photoreal look.
          </p>
          ...
          <fieldset className="mt-6">
            ...
            <div className="mt-2 grid grid-cols-3 gap-2 sm:gap-3">
              {[
                { src: "/sites/aiclotheschanger-root-8816f3e1/images/hero-person-1.webp", alt: "Woman in a white tank top", pressed: true },
                { src: "/sites/aiclotheschanger-root-8816f3e1/images/hero-person-2.webp", alt: "Man in a white T-shirt", pressed: false },
                { src: "/sites/aiclotheschanger-root-8816f3e1/images/hero-person-3.webp", alt: "Woman in a beige knit top", pressed: false },
              ].map((p, i) => (
                <button
                  key={i}
                  ...
                  className={cn(
                    ...
                    p.pressed && "ring-2 ring-[#191613] ring-offset-2 ring-offset-white"
                  )}
                >
                  <img src={p.src} alt={p.alt} className="absolute inset-0 h-full w-full object-cover" />
                </button>
              ))}
            </div>
          </fieldset>
          ...
          <fieldset className="mt-5">
            ...
            <div className="mt-2 flex gap-4">
              <label className="flex items-center gap-2 text-sm text-[#191613]">
                <input type="radio" name="outfit-mode" defaultChecked />{" "}
                Use clothing photos
              </label>
              <label className="flex items-center gap-2 text-sm text-[#191613]">
          ...
          <fieldset className="mt-5">
            ...
            <div className="mt-2 grid grid-cols-3 gap-2 sm:gap-3">
              {[
                { src: "/sites/aiclotheschanger-root-8816f3e1/images/hero-cloth-1.webp", alt: "Blue denim jacket", pressed: true, size: "sm" },
                { src: "/sites/aiclotheschanger-root-8816f3e1/images/hero-cloth-2.webp", alt: "White floral dress", pressed: false, size: "sm" },
                { src: "/sites/aiclotheschanger-root-8816f3e1/images/hero-cloth-3.webp", alt: "Black leather biker jacket", pressed: false, size: "sm" },
              ].map((c, i) => (
                <button
                  key={i}
